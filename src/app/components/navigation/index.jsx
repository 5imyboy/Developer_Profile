    ...
    return (
        ...
        <div className='w-full fixed h-screen flex items-center justify-center'>
            ...
            {({size}) => {
                ...
                initial='hidden'
                animate='show'
                className='relative w-max flex items-center justify-center animate-spin-slow hover:pause group'>
                    {
                ...
                initial='hidden'
                animate='show'
                className='relative w-full px-2.5 xs:w-max xs:px-0 flex flex-col space-y-4 items-start xs:items-center justify-center group'>
                    {
                ...
                initial='hidden'
                animate='show'
                className='relative w-full px-2.5 xs:w-max xs:px-0 flex flex-col space-y-4 items-end xs:items-center justify-center group'>                    {
